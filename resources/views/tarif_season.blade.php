        ...
        <div class="col-lg-6">
	        ...
	        <br>
	        	<div class="form-group">
	            	<input class="form-control" name="tarifbaru" placeholder="Masukkan Tarif Baru" 
	            	value="<?php if($dataTarif != null) echo $dataTarif->HARGA_TARIF; else ""; ?>">
                            	...
                            	<form method="POST" action="{{ route('tarif.hapus', $data->ID_TARIF) }}" accept-charset="UTF-8">
		                        	<input name="_method" type="hidden" value="DELETE">
			                       	<input name="_token" type="hidden" value="{{ csrf_token() }}">
			                            <a href="{{ route('tarif.edit', $data->ID_TARIF) }}" class="btn btn-default btn-xs"><i class="fa fa-info-circle"></i> Edit</a>
                        ...
                        <tr>
                            ...
                            <td>
                            	<form method="POST" action="{{ route('season.hapus', $data->ID_SEASON) }}" accept-charset="UTF-8">
		                        	<input name="_method" type="hidden" value="DELETE">
			                       	<input name="_token" type="hidden" value="{{ csrf_token() }}">
			                            <a href="{{ route('season.edit', $data->ID_SEASON) }}" class="btn btn-default btn-xs"><i class="fa fa-info-circle"></i> Edit</a>
